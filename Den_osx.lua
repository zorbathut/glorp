...
rv.create_runnable = function(dat)
  local basepath = "build/" .. params.name .. ".app"
  ...
  table.insert(runnable, ursa.rule{basepath .. "/Contents/MacOS/" .. params.name, dat.mainprog, ursa.util.system_template{"cp $SOURCE $TARGET"}})
  ...
  return {deps = runnable, cli = basepath .."/Contents/MacOS/" .. params.name}
end
