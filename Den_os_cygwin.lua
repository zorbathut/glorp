...
token_literal("FINALLDFLAGS", "-Wl,--large-address-aware -Wl,-subsystem,windows -mno-cygwin -static-libgcc -lopengl32 -lmingw32 -lwinmm -lkernel32 -luser32 -lgdi32 -lwinspool -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -luuid -lodbc32 -lodbccp32 -ldinput -ldxguid -lglu32 -lws2_32 -limagehlp -lpsapi -ldinput -ldinput8")
...
rv.create_runnable = function(dat)
  ...
  local dlls = {}
  table.insert(dlls, ursa.rule{("%s%s"):format(liboutpath, "OpenGAL32-1.dll"), ("%s%s"):format(liboutpath, "lib_release/bin/OpenGAL32-1.dll"), ursa.util.copy{}})
...
function rv.installers()
  ...
  table.insert(data, ursa.rule{params.builddir .. "deploy/OpenGAL32-1.dll", params.builddir .. "OpenGAL32-1.dll", ursa.util.system_template{"cp $SOURCE $TARGET && strip -s $TARGET"}})
